...
function TechnologyCard({ tech }) {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-300/60">
      ...
      <button className="mt-5 w-full rounded-lg bg-[#0a0f1d] py-2.5 text-sm font-semibold text-white hover:bg-slate-800">
        Add to Stack
      </button>
    </div>
  )
